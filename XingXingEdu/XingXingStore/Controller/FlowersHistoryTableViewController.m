...
- (void)viewDidLoad {
    ...
    [[self navigationItem] setTitle:@"赠送历史"];
    [self initData];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SendFlowerBaskerDetailVC.teacherLabel = tnameMArr[indexPath.row];
    SendFlowerBaskerDetailVC.numLabel = numMArr[indexPath.row];
    SendFlowerBaskerDetailVC.timeLbl = date_tmMArr[indexPath.row];
    SendFlowerBaskerDetailVC.textLabe = conMArr[indexPath.row];
