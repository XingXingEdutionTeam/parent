...
-(void)creatField{
    ...
    //收货人
    UILabel *consigneeLabel = [HHControl createLabelWithFrame:CGRectMake( 20, 5,( kWidth - 40)/2, KLabelH) Font:14 Text:[NSString stringWithFormat:@"收货人:%@",orderArray[8]]];
    ...
    UILabel *timeLabel = [HHControl createLabelWithFrame:CGRectMake(20, CGRectGetMaxY(line5.frame), kWidth - 40, KLabelH) Font:14 Text:@""];
    
    if ([orderArray[15] isEqualToString:@"0"]) {
        timeLabel.text = @"";
        //重写bgTimeView的大小
        bgTimeView.frame = CGRectMake(5,CGRectGetMaxY(bgAccountView.frame) + Kmarg , kWidth - 10, 35);
    }else if ([orderArray[15] isEqualToString:@"1"]){
        ...
        timeLabel.text =[NSString stringWithFormat:@"收货时间还剩%@",orderArray[13]];
        //重写bgTimeView的大小
