...
- (void)submit{
    ...
    if (_other_xidStr == nil) {
        //被举报的是图片
    params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"report_name_id":report_name_idStr, @"report_type":@"2", @"url":_picUrlStr, @"origin_page":_origin_pageStr};
    }else{
    //被举报的是人
    params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"report_name_id":report_name_idStr, @"report_type":@"1", @"other_xid":_other_xidStr};
    }
