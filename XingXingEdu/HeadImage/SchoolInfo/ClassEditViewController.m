 ...
 */
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"school_id":schoolIdStr, @"sch_type":schoolTypeStr, @"class_id":classIdStr, @"examine_id":auditorIdStr, @"baby_id":babyId};
//    NSLog(@" params --  %@", params);
...
- (void)fetchSchoolNameData{
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"school_type":schoolTypeStr, @"province":provinceStr, @"city":cityStr , @"district": areaStr};
...
- (void)fetchGradeData{
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"school_type":schoolTypeStr, @"school_id":schoolIdStr};
...
- (void)fetchClassData{
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"course_id":courseIdStr, @"school_id":schoolIdStr, @"grade":gradeStr};
...
- (void)fetchAuditData{
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"class_id":classIdStr, @"school_id":schoolIdStr};
