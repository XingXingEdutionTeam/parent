...
//    NSString *lvString = [NSString stringWithFormat:@"LV%@", lv];
    ...
    UIButton *checkBtn =[HHControl createButtonWithFrame:CGRectMake(40 * kWidth / 375, 205 * kWidth / 375, 57 * kWidth / 375, 26 * kWidth / 375) backGruondImageName:@"签到106x48@2x" Target:self Action:@selector(check) Title:@""];
    
    [self.view addSubview:checkBtn];
    UILabel *checkLbl =[HHControl createLabelWithFrame:CGRectMake(145 * kWidth / 375, 205 * kWidth / 375, 120 * kWidth / 375, 15 * kWidth / 375) Font:12 * kWidth / 375 Text:[NSString stringWithFormat:@"已连续签到%@天",continued]];
    checkLbl.textColor =UIColorFromRGB(255, 255, 255);
    [self.view addSubview:checkLbl];
    
    UILabel *checkInLbl =[HHControl createLabelWithFrame:CGRectMake(145 * kWidth / 375, 220 * kWidth / 375, 200 * kWidth / 375, 15 * kWidth / 375) Font:12 * kWidth / 375 Text:[NSString stringWithFormat:@"明天继续签到将获得%@个猩币",next_get_coin]];
