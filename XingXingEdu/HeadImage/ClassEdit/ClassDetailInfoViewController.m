...
//    _schoolTypeLabel.text = _schoolTypeStr;
    ...
    _gradeLabel = [[UILabel alloc] initWithFrame:CGRectMake(90 * kWidth / 375, 310 * kWidth / 375, 120* kWidth / 375, 30 * kWidth / 375)];
...
//    _gradeLabel.text = [NSString stringWithFormat:@"%@年级", [WZYTool changeStringFromFigure:_gradeStr]];
    ...
    _classLabel = [[UILabel alloc] initWithFrame:CGRectMake(220 * kWidth / 375, 310 * kWidth / 375, 140 * kWidth / 375, 30 * kWidth / 375)];
    _classLabel.font = [UIFont systemFontOfSize:14 * kWidth / 375];
