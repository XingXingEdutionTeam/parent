 ...
 */
    ...
    if (_codeFlag == YES) {
        //护照
    params = @{@"appkey":@"U3k8Dgj7e934bh5Y", @"backtype":@"json", @"xid":@"18884982", @"user_id":@"1", @"user_type":@"1", @"baby_nickname":_rightTextField1.text, @"tname":_rightTextField2.text, @"passport":_rightTextField3.text, @"relation":self.relationCombox.textField.text};
    ...
    params = @{@"appkey":@"U3k8Dgj7e934bh5Y", @"backtype":@"json", @"xid":@"18884982", @"user_id":@"1", @"user_type":@"1", @"baby_nickname":_rightTextField1.text, @"tname":_rightTextField2.text, @"id_card":_rightTextField3.text, @"relation":self.relationCombox.textField.text, @"sex":sexStr, @"age":ageStr};
