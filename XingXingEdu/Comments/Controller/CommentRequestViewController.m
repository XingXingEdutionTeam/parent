 ...
 */
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"tid": teacherIdStr, @"class_id": class_idStr, @"school_id": schoolIdStr, @"baby_id": babyIdStr, @"ask_con": self.requestText.text};
